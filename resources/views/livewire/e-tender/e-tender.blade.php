        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7" class="text-center text-muted py-4">No e-tenders found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
                    ...
                    <form wire:submit.prevent="save">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                @if($mode === 'add') Add New E-Tender
                                @elseif($mode === 'edit') Edit E-Tender
                                @else View E-Tender @endif
                            </h5>
                        ...
                        <div class="modal-footer">
                            ...
                            @if($mode != 'view')
                                <button type="submit" class="btn btn-primary">
                                    <span wire:loading.remove wire:target="save">@if($mode === 'add') Add E-Tender @else Update E-Tender @endif</span>
